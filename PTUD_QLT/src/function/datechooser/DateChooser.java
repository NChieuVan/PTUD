...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdForward = new function.datechooser.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new function.datechooser.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new function.datechooser.Button();
        cmdPrevious = new function.datechooser.Button();
        slide = new function.datechooser.Slider();
    ...
    private function.datechooser.Button cmdForward;
    private function.datechooser.Button cmdMonth;
    private function.datechooser.Button cmdPrevious;
    private function.datechooser.Button cmdYear;
    private javax.swing.JPanel header;
    private javax.swing.JLabel lb;
    private javax.swing.JPopupMenu popup;
    private function.datechooser.Slider slide;
